...
class DoxygenAwesomeFragmentCopyButton extends HTMLElement {
    ...
    static init() {
        $(function() {
            $(document).ready(function() {
                // Show copy button when Clipboard API is available OR when execCommand fallback is possible.
    ...
    copyContent() {
        ...
        if (navigator.clipboard && navigator.clipboard.writeText) {
            navigator.clipboard.writeText(textContent).then(onSuccess).catch(() => {
                // Fallback to execCommand
                DoxygenAwesomeFragmentCopyButton.execCommandCopy(textContent, onSuccess);
            });
        } else {
            DoxygenAwesomeFragmentCopyButton.execCommandCopy(textContent, onSuccess);
        }
    ...
    static execCommandCopy(text, onSuccess) {
        try {
